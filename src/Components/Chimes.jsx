...
export const Chimes = (props) => {
  ...
  const [chimeNotes, setChimeNotes] = useState(
    props.match.params.notes ? props.match.params.notes.split(",") : []
  );
  ...
  const getWindspeed = (lat = -38.2527, lon = 85.7585) => {
    // default location is Louisville, Ky
  ...
  return (
    <div className="app">
      ...
      {chimeNotes.length === 0 ? (
        <Instructions material={material} />
      ) : (
        <div className="instrument">
          <BracketGraphic theme={props.theme} />
